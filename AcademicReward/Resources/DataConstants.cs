...
public static class DataConstants {
    ...
    public const string LoginGroupCollectionMessage =
        "An error occurred while gathering your groups. The application can still be used, but no groups will load. Try logging out and in again.";
    ...
    public const string InvalidReEnterNewPasswordLengthMessage =
        "Re-enter new password must be between 1-50 characters.";
    ...
    public const string InvalidNotificationDescriptionLengthMessage =
        "Notification description must be between 1-250 characters.";
    ...
    public const string AddMemberUnknownErrorMessage =
        "An unknown error occurred while adding the member to the group.";
    //Add Member END

    //Home Page START
    public const string TaskSubmittedTitle = "Task Submitted!";

    public const string TaskSubmittedMessage =
        "Task was succesfully submitted. You are now waiting for approval from your group admin.";

    public const string TaskApprovedTitle = "Task Approved!";

    public const string TaskApprovedMessage =
        "Task was succesfully approved. The member will receive their points and XP the next time they sign in.";
    //Home Page END
